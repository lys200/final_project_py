...
class Gestion_Salle:
    ...
    def modifier(self):        
        ...
        id_salle = is_empty("Entrer le id de ;a salle a a modifier: \n -->")
                ...
                while True:
                    try:
                        ...
                        if sieges < 0 or sieges > 70:
                            ...
                            db.update_data(self.curseur,"Salles", id_salle, nombre_de_siege = sieges)
                            break
        else:
                ...
                while True:
                    try:
                        ...
                        if num_etage< 0 or num_etage > 2:
                            ...
                            datas = db.search_by_data(self.curseur, "Salles","num_salle", etage = num_etage )
                            if not datas:
    ...
    def menu_salle (self) :
        ...
        while True:
            ...
            if self.adm_id :
                ...
                try:
                    choix = int(input("Veuillez choisir votre option.[1-6]: "))
                except Exception as e:
                ...
                try:
                    ...
                    if choix < 1 or choix > 6:
                        print("Entrée invalide. Veuillez choisir un chiffre entre 1 et 6.\n")
                    else:
                        if choix == 1:
